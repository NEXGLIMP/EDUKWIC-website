		...
		<div class="account-form-inner">
			...
			<div class="account-container">
				<div class="heading-bx left">
					...
					<p>Hey champ! New here? <a href="register.html">Get Membership</a> to get started</p>
				</div>	
				<form class="contact-bx" method="post" action="phpfunctions/authcode.php">
					<div class="row placeani">
						...
						<div class="col-lg-12 m-b30">
							<button name="login_btn" type="submit" value="Submit" class="btn button-md">Login</button>
						</div>
						<!-- <div class="col-lg-12">

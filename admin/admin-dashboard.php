		...
		<div class="ttr-header-wrapper">
			...
			<div class="ttr-header-menu">
				...
				<ul class="ttr-header-navigation">
                    ...
                    <li>
						<a href="../courses.html" class="ttr-material-button ttr-submenu-toggle">COURSES</a>
					</li>
					<!-- <li>
	...
	<div class="ttr-sidebar">
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					<li>
						<a href="admin-dashboard.html" class="ttr-material-button">
							<!-- <span class="ttr-icon"><i class="ti-home"></i></span> -->
		                	<span class="ttr-label">Dashboard</span>
		                </a>
		            </li>
					<li>
						<a href="users-details.html" class="ttr-material-button">
							<!-- <span class="ttr-icon"><i class="ti-book"></i></span> -->
		                	<span class="ttr-label">Users Details</span>
		                </a>
		            </li>
					<li>
						<a href="membership-admin.html" class="ttr-material-button">
					...
					<li>
						<a href="add-courses.html" class="ttr-material-button">
					...
					<li>
						<a href="update-courses.html" class="ttr-material-button">
							<!-- <span class="ttr-icon"><i class="ti-bookmark-alt"></i></span> -->
		                	<span class="ttr-label">Update Courses</span>
		                </a>
		            </li>
                    <li>
						<a href="delete-courses.html" class="ttr-material-button">
							<!-- <span class="ttr-icon"><i class="ti-bookmark-alt"></i></span> -->

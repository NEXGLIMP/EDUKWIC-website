            ...
            <div class="container">
             ...
             <div class="row">
                <div class="col-sm-6" style="text-align: center;">
                    <img src="assets/images/testimonials/pic1.jpg" class="rounded img-fluid" width="200px">
                </div>
                <div class="col-sm-6">
                    <div class="m-4">
                    <p style="font-size: 22px;color: black;"><strong>User ID: </strong><span>0001</span></p>
                    <p style="font-size: 22px;color: black;"><strong>User Name: </strong><span>Hari</span></p>
                    <p style="font-size: 22px;color: black;"><strong>E-Mail: </strong><span>hari@gmail.com</span></p>
                    <p style="font-size: 22px;color: black;"><strong>User Mobile: </strong><span>9835216537</span></p>
                    <p style="font-size: 22px;color: black;"><strong>E-Mail: </strong><span>hari@gmail.com</span></p>

                    </div>
                </div>
             </div>
             <div class="courses-started">
                <div class="section-area section-sp1">
                    <div class="container">
                        <h3 class="text-center">Courses Started</h3>
                                ...
                                <div class="item">
                                    <div class="cours-bx">
                                        ...
                                        <!-- <div class="cours-more-info">
                                            <div class="review">
                                                <span><i class="fa-solid fa-clock"></i><span> 5</span>hrs</span>
                                             
                                            </div>
                                         
                                            <div class="review">
                                                <span><i class="fa-solid fa-book"></i> Lectures: <span>10</span></span>
                                            </div>
                                        </div> -->
                                    </div>
                                </div>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <span class="new-users-btn">
                                        <a href="#" class="btn button-sm outline">VIEW DETAILS</a>
                                    </span>
                                </li>
                                <li>
                                    <span class="new-users-pic">

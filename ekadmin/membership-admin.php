		...
		<div class="ttr-sidebar-wrapper content-scroll">
			...
			<nav class="ttr-sidebar-navi">
				<ul>
					...
					<li>
						<a href="verify-certificate.php" class="ttr-material-button">
	...
	<main class="ttr-wrapper">
		<div class="container-fluid">
			<div class="db-breadcrumb">
            	...
            	<!-- Card -->
                 <div class="container">
                    <h4 class="text-center">CURRENT MEMBERSHIP PLANS</h4>
                    <div class="row">
                        <div class="col-sm-3">
                        <div class="course1 card">    
                            <div class="card-body">
                                <!-- <h4 class="card-title">PLAN: <span style="color: rgb(99, 24, 170);">MEDIUM</span></h4> -->
                                <div class="pricingtable-wrapper">
                                    <div class="pricingtable-inner">
                                        <div class="pricingtable-main"> 
                                            <div class="pricingtable-price"> 
                                                <!-- <span class="priceing-doller">₹</span> -->
                                                <span style="color: white; font-size: 30px;">₹399</span><br>
                                ...
                                <a href="#" class="btn btn-primary mt-4">UPDATE PLAN</a>
                              </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="pricingtable-wrapper">
                                    <div class="pricingtable-inner">
                                        <div class="pricingtable-main"> 
                                            <div class="pricingtable-price"> 
                                                <!-- <span class="priceing-doller">₹</span> -->
                                                <span style="color: white; font-size: 30px;">₹999</span><br>
                                ...
                                <div class="pricingtable-wrapper">
                                    <div class="pricingtable-inner">
                                        <div class="pricingtable-main"> 
                                            <div class="pricingtable-price"> 
                                                <!-- <span class="priceing-doller">₹</span> -->
                                                <span style="color: white; font-size: 30px;">₹1499</span><br>
                                ...
                                <div class="pricingtable-wrapper">
                                    <div class="pricingtable-inner">
                                        <div class="pricingtable-main"> 
                                            <div class="pricingtable-price"> 
                                                <!-- <span class="priceing-doller">₹</span> -->
                                                <span style="color: white; font-size: 30px;">₹2499</span><br>
                                                <span class="pricingtable-type">3 Month</span>
                                            </div>
                                            <div class="pricingtable-title">
                                                <h2>PRO</h2><br>
